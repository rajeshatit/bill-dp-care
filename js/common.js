...
//                var custom_date = cus.getDate() +' - ' + cus.getMonth() + ' - ' + cus.getFullYear();
                ...
                send_msg = 'Hi('+ obj.customer_name +') this is friendly reminder from DP wheel care point kpm, that your vehicle ('+ obj.city +')  free wheel alignment  Will end tomorrow ('+ custom_date +').\nplease check it  for comfortable and safe drive.\nRgds,\nDP wheel care point.';
            }
        }
        if(checked_msg == 3){
            send_msg = 'jkjkgjkgh';
